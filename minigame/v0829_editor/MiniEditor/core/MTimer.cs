...
namespace MiniEditor
{
    ...
    public class MTimer
    {
        ...
        Func<UInt32> mTimer;
        UInt32 mLast = 0;
        public MTimer(Func<UInt32> t, int id)
        {
            mTimer = t;
            mLast = t();
            mID = id;
        ...
        static SortedDictionary<int, MTimer> mID2Timer = new SortedDictionary<int, MTimer>();
        static SortedDictionary<int, MTimer> mPreID2Timer = new SortedDictionary<int, MTimer>();
        ...
        public static MTimer get(int level = 0)//DEFAULT
        {
            MTimer mout;
            ...
            else
            {
                ...
                var t = new MTimer(mGlobalTimer, level);
